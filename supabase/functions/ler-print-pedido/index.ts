...
serve(async (req) => {
  ...
  try {
    ...
    const system = [
      ...
      "- 'taxa_entrega': o valor da taxa/frete de entrega se aparecer no print (só o número). Senão null.",
    ...
    const dados = {
      ...
      taxa_entrega: parsed.taxa_entrega != null ? Number(parsed.taxa_entrega) : null,
