-- Período personalizado na tela Entregadores: além do início (p_desde), agora dá
-- pra limitar o fim (p_ate). A versão de 2 parâmetros é derrubada de propósito —
-- se as duas ficassem no banco, a chamada com 2 argumentos ficaria ambígua.

DROP FUNCTION IF EXISTS public.entregadores_resumo(uuid, timestamptz);
