-- Migration 0007: adiciona fluxo de convite de admin para empresa criada pelo super_admin
-- tipo_cadastro='admin_empresa' + empresa_id no metadata → perfil='admin' vinculado à empresa
